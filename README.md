...
|------------------|------------------------|-----|-----------------------------|----------------------|----------------------|---------------------------------------|
| 讯飞星火大模型   | 科大讯飞股份有限公司  | 是           | 是      | 否                   | 支持文档数据集关联，提供助手API定制 | https://xinghuo.xfyun.cn/botcenter   |
| 智谱清言         | 智谱                |              | 是       | 否      |     | https://chatglm.cn/glms             |
| 扣子             | 字节              | 是            | 是       | 是    | 支持智能体配置推送到飞书，服务号，订阅号，微信客服   | https://www.coze.cn/home             |
